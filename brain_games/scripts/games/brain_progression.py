...
def is_progression_game():  # выбор неизвестных для одного раунда игры
    ...
    for _ in range(len_of_progression - 1):  # длина прогрессии минус первоначально известный элемент
        new_element: int = subsequence[-1] + step_of_progression  # сумма последнего элемента прогрессии и длины шага прогрессии
